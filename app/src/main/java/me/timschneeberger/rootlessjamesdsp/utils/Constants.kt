...
object Constants {
    ...
    const val PREF_DARWIN = "dsp_darwin"
    ...
    const val ACTION_SERVICE_UPDATE_LIVEPROG_PARAMETER = BuildConfig.APPLICATION_ID + ".action.service.UPDATE_LIVEPROG_PARAMETER"
    ...
    const val ACTION_PROCESSING_STATUS = BuildConfig.APPLICATION_ID + ".action.service.PROCESSING_STATUS"
    const val ACTION_PROCESSING_BYPASS = BuildConfig.APPLICATION_ID + ".action.service.PROCESSING_BYPASS"
    ...
    const val EXTRA_PROCESSING_LOAD = BuildConfig.APPLICATION_ID + ".extra.service.PROCESSING_LOAD"
    const val EXTRA_UNDERRUN_COUNT = BuildConfig.APPLICATION_ID + ".extra.service.UNDERRUN_COUNT"
    const val EXTRA_LIMITER_REDUCTION = BuildConfig.APPLICATION_ID + ".extra.service.LIMITER_REDUCTION"
    const val EXTRA_DARWIN_HEADROOM = BuildConfig.APPLICATION_ID + ".extra.service.DARWIN_HEADROOM"
    const val EXTRA_PROCESSING_BYPASSED = BuildConfig.APPLICATION_ID + ".extra.service.PROCESSING_BYPASSED"
    const val EXTRA_LIVEPROG_PARAMETER_NAME = BuildConfig.APPLICATION_ID + ".extra.service.LIVEPROG_PARAMETER_NAME"
    const val EXTRA_LIVEPROG_PARAMETER_VALUE = BuildConfig.APPLICATION_ID + ".extra.service.LIVEPROG_PARAMETER_VALUE"
}
